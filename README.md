...
===========================
> This is the framework theme. If you want to install a fresh WordPress + Themosis framework application, please visit the main repository [themosis/themosis](https://github.com/themosis/themosis).
