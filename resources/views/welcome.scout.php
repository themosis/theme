...
<div id="app">
	<div class="wrapper">
		<div class="head">
			...
			<h1>{{ __('Congratulations!', THEME_TEXTDOMAIN) }}</h1>
			<p>{{ __('The Themosis framework is running.', THEME_TEXTDOMAIN) }}</p>
		</div>
		<div class="frame clearfix">
			<div id="get-started">
				<div class="container">
					<h2>{{ __('Get started:', THEME_TEXTDOMAIN) }}</h2>
					<p>{{ __('Check the documentation and build your next WordPress website/application.', THEME_TEXTDOMAIN) }}</p>
					<a href="http://framework.themosis.com/docs/" target="_blank" title="{{ __('Themosis framework documentation', THEME_TEXTDOMAIN) }}">{{ __('View documentation', THEME_TEXTDOMAIN) }}</a>
				</div>
			</div>
			<div id="links">
				<div class="container">
					<h3>{{ __('Links:', THEME_TEXTDOMAIN) }}</h3>
					<ul>
